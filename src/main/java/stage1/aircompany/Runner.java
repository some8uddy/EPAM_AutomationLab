package stage1.aircompany;

import stage1.aircompany.models.MilitaryType;
import stage1.aircompany.planes.AbstractPlane;
import stage1.aircompany.planes.MilitaryPlane;
import stage1.aircompany.planes.PassengerPlane;
...
public class Runner {
    ...
    private static List<AbstractPlane> planes =
        Arrays.asList(
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "Passenger airport sorted by max speed: " + passengerAirport.sortByMaxSpeed()
                                                                        .toString());
